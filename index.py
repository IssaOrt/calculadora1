...
def calculadora():
    ...
    if request.method == "POST":
        try:
            ...
            if mask == "0.0.0.0":
                data["error"] = "La máscara 0.0.0.0 no es válida."
                return render_template("index.html", data=data)
            ...
            if primer_octeto <= 126: data["clase"] = "A"
            elif primer_octeto <= 191: data["clase"] = "B"
            elif primer_octeto <= 223: data["clase"] = "C"
            elif primer_octeto <= 239: data["clase"] = "D"
            else: data["clase"] = "E"
